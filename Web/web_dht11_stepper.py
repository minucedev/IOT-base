...
setInterval(async () => {
    ...
    try {
        ...
        // Raspberry Pi tạm thời không phản hồi
...
# LƯU Ý:
#
# UI FORWARD  -> MOTOR BACKWARD
# UI BACKWARD -> MOTOR FORWARD
#
# Vì motor thực tế đang quay ngược chiều.
# ============================================================
